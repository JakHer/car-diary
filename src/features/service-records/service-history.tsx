...
export const ServiceHistory = ({
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <p className="m-0 mb-2.5 text-xs font-extrabold tracking-[0.09em] text-accent uppercase">{t('history.eyebrow')}</p>
          <h2 className="m-0 text-[22px] font-bold tracking-[-0.025em] text-strong">{t('history.title')}</h2>
        </div>
