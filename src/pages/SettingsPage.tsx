...
import { isDistanceUnit } from '../lib/distanceUnits'
import {
  cardStyles,
  eyebrowStyles,
  joinClassNames,
  ...
  return (
    <div className="mx-auto flex min-h-svh w-[calc(100%_-_40px)] max-w-[1180px] flex-col max-[700px]:w-[calc(100%_-_28px)]">
      ...
      <main className="mx-auto w-full max-w-[760px] py-14 pb-20 max-[700px]:py-10 max-[700px]:pb-14">
        <p className={eyebrowStyles}>{t('settings.eyebrow')}</p>
        ...
        <form
          className={joinClassNames(cardStyles, 'mt-9 overflow-hidden')}
          aria-busy={isSaving}
        ...
        >
          ...
          <div className="flex min-h-[94px] items-center justify-between gap-5 border-t border-border bg-surface-muted/40 px-7 py-5 max-[700px]:flex-col max-[700px]:items-stretch max-[700px]:px-[22px]">
            <div className="min-h-[20px] text-[13px] font-semibold">
              ...
              {saveStatus === 'error' && (
                <span className="text-[#a62b2b]" role="alert">
